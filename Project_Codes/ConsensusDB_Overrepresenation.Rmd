...
pacman::p_load("readr","tidyverse", "openxlsx", "stringr", "ontologyIndex", "biomaRt",
               "data.table","BiocManager","devtools", "archive", "shiny","DT", "RCurl")
...
PP_Go_detection <- function(x){
  ...
  results_1 <- getBM(attributes = gm_attribute_input, filters = "uniprotswissprot",
           values = Uniprots_PPI1, mart = mart, curl=curlHandle)
  
  results_2 <- getBM(attributes = gm_attribute_input, filters = "uniprotswissprot",
           values = Uniprots_PPI2, mart = mart, curl=curlHandle)
...
columns_of_interest <- c("uniprotswissprot", "description", "Name_provided", "GO_POI", "POI_Go_found", "PPI1", "Go_count_PPI1", "PPI2", "Go_count_PPI2") 


write.xlsx(Converted[,columns_of_interest],"./../Project_Output/POIs_sorted.xlsx")
```
