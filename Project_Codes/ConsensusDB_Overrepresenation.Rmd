...
library(knitr)
opts_chunk$set(engine.path = 'C:/Users/skourtis/PycharmProjects/ConsensusDB/venv/Scripts/python.exe')

Sys.setenv(RETICULATE_PYTHON = "C:/Users/skourtis/PycharmProjects/ConsensusDB/venv/Scripts/python.exe")
library(reticulate)

```

```{python Cleaning and filtering}
variable = 5
```
